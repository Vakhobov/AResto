...
export function PhoneVerificationModal({ order, isOpen, onClose, onVerified }: PhoneVerificationModalProps) {
            ...
            <div className="bg-card rounded-3xl p-6 w-full max-w-md shadow-2xl border border-border">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-foreground">Telefon raqamini tasdiqlash</h2>
              ...
              <div className="bg-secondary/50 rounded-2xl p-4 mb-6">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-foreground font-medium">
                    {order.orderType === 'dine-in' ? `#${order.tableNumber}` : 'Olib ketish'}
                  </span>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-foreground mb-2 block">
                    Buyurtma berilganda ishlatilgan telefon raqamining oxirgi 4 raqamini kiriting
                  </label>
                  <input
                    type="text"
                    value={last4Digits}
